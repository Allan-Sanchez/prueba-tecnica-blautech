package com.pruebatecnica.authservice.controller;

import com.pruebatecnica.authservice.dto.*;
import com.pruebatecnica.authservice.entity.User;
import com.pruebatecnica.authservice.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<UserDto>> getCurrentUser() {
        try {
            ...
            log.info("Getting current user profile for email: {}", authenticatedUser.getEmail());
    ...
    public ResponseEntity<ApiResponse<UserDto>> updateCurrentUser(@Valid @RequestBody UpdateUserRequest request) {
        try {
            ...
            log.info("Updating current user profile for email: {}", authenticatedUser.getEmail());
    ...
    public ResponseEntity<ApiResponse<Void>> logout() {
        try {
            ...
            log.info("Logout request for user ID: {} - {}", authenticatedUser.getId(), authenticatedUser.getEmail());
